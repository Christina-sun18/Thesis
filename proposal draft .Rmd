...
vix_table <- rename(vix_table, "In-sample optimizers" = Row,"FSR 10%" = FSR10, "FSR 20%"=FSR20, "FSR 80%"=FSR80,"FSR 90%"=FSR90)
vix_table$`In-sample optimizers`<-c("LS","CRPS","FSR 10%","FSR 20%","FSR 80%","FSR 90%")
