...
^[Note: Specification senario 1 and 2 are based on equations (24)-(26); Specification 3 and 4 are based on equations (25)-(28)]
...
### 5.4.2 Results of specification 2: Student-t error
...
# put two plots side by side 
ggarrange(fsr10plot,fsr90plot,ncol=2,legend = "bottom",labels = c("Figure 7(a) Lower Tail","Figure 7(b) Upper Tail"))
```

### 5.4.3 Results of specification 3: time-varying volatility and normal error 
...
# put two plots side by side 
ggarrange(fsr10plot,fsr90plot,ncol=2,legend = "bottom",labels = c("Figure 8(a) Lower Tail","Figure 8(b) Upper Tail"))

```

### 5.4.4 Results of specification 4: time-varying volatility and Student-t error
...
# put two plots side by side 
ggarrange(fsr10plot,fsr90plot,ncol=2,legend = "bottom",labels = c("Figure 9(a) Lower Tail","Figure 9(b) Upper Tail"))
...
3. The integral of CRPS is hard to compute once we move away from the normal distribution assumption, since there is usually no closed form for the integral. 

4. The reasons why we can gain considerabley after the GFC needs further investigation. 
