...
fsr10plot <- fsr10 %>% ggplot(aes(x=Date)) +
  geom_line(aes(y = CLS10,color = "CLS10"),size=0.3,linetype = "dashed")+
  geom_line(aes(y = CLS20,color = "CLS20"),size=0.5,linetype = "dotted")+
  geom_line(aes(y = MLE,color = "MLE"),size=0.3,linetype = "solid")+
  geom_line(aes(y = CRPS,color = "CRPS"),size=0.3, linetype = "longdash")+
